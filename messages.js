...
const MESSAGES = {
  ...
  // 登録
  registration: {
    success: '✅ ありがとうございます。早速、「一覧」を押してみましょう！\n\nすると予定を確認できます。今はまだ何もないと思います。\n\n使い方が分からない時は「ヘルプ」と送信してください。',
  ...
  query: {
    ...
    tomorrowResult: '明日のゴミは【{0}】です。',
    notes: '\n📝 注意事項：{0}',
    notFound: '{0}のゴミ出し情報は見つかりませんでした。',
  ...
  flex: {
    ...
    schedulePrompt: '変更したい曜日があれば、カードをタップして編集できます。（タップした後、数秒お待ち下さい！）',
  },
};
...
/**
 * [対話] 注意事項を尋ねるメッセージを生成します。
 * @param {string} currentNote - 現在の注意事項
 * @returns {object} LINE送信用メッセージオブジェクト
 */
